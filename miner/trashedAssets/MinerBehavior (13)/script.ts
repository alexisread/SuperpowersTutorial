class MinerBehavior extends Sup.Behavior {
  speed = 0.3;
  jumpSpeed = 0.45;
  ...
  update() {
    ...
    // let touchRock = this.actor.arcadeBody2D.getTouches().rock;
    if (touchBottom) {
      if (Sup.Input.wasKeyJustPressed("UP")) {
        ...
        else this.actor.spriteRenderer.setAnimation("Roll");
      }
    } else {
...
// Sup.registerBehavior(MinerBehavior);